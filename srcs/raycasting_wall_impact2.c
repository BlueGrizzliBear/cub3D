...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   raycasting_wall_impact2.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: cbussier <cbussier@student.le-101.fr>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/24 09:38:54 by cbussier          #+#    #+#             */
/*   Updated: 2020/02/28 10:35:46 by cbussier         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_compare(t_pos sqr_pos, t_mmap *mmap, int cb_s)
{
	...
	if (!(int_pos_x >= 0 && int_pos_x < mmap->input->max.x) ||
	!(int_pos_y >= 0 && int_pos_y < mmap->input->max.y))
		return (1);
